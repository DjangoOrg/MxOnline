# Generated by Django 2.1.4 on 2018-12-19 12:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree', models.CharField(choices=[('cj', '初级'), ('zj', '中级'), ('gj', '高级')], default='cj', max_length=4, verbose_name='课程难度')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('download', models.FileField(upload_to='courses/resource/%Y/%m', verbose_name='文件')),
                ('add_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
